    ...
    <section className="cpf-hero">
      <div className="cpf-hero-inner">
        <div className="cpf-hero-eyebrow">
          ...
          Intelligence Layer Workshop — September 26th
        </div>
        <h1>Your Expert<br /><em>Profile.</em></h1>
        <p className="cpf-hero-sub">
          This is not a test. There are no right answers. The thinking you do answering these questions is already part of your preparation for September 26th.
        </p>
