          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
            <div>
              ...
              <input type="text" value={name} onChange={e => setName(e.target.value)} placeholder="Your first name" required
                style={{ width: '100%', padding: '14px 16px', borderRadius: '10px', border: '1.5px solid var(--border)', fontFamily: "'DM Sans', sans-serif", fontSize: '.94rem', color: 'var(--ink)', background: 'var(--warm)', outline: 'none' }} />
            </div>
            <div>
            ...
            <button type="submit" disabled={loading}
              style={{ width: '100%', padding: '15px', background: 'var(--coral)', color: '#fff', border: 'none', borderRadius: '40px', cursor: loading ? 'not-allowed' : 'pointer', fontFamily: "'DM Sans', sans-serif", fontSize: '.95rem', fontWeight: 600, opacity: loading ? .6 : 1, marginTop: '4px' }}>
