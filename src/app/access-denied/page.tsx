      ...
      <div style={{ minHeight: '100vh', background: 'var(--ink)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '80px 28px', textAlign: 'center' }}>
        <div style={{ maxWidth: '460px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', alignItems: 'center' }}>
            <Link href="/" style={{ display: 'inline-flex', alignItems: 'center', gap: '9px', background: 'var(--coral)', color: '#fff', fontFamily: "'DM Sans', sans-serif", fontSize: '.92rem', fontWeight: 600, padding: '14px 32px', borderRadius: '50px', textDecoration: 'none' }}>
              Back to homepage
            </Link>
